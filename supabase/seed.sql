-- ==============================================================================
-- supabase/seed.sql
-- Production & Development Master Seed File
-- Root SuperAdmin: admin@jyotirmoyb.com
-- Default Enterprise Tenant: Enterprise Core (code: CORE-SYS, slug: core)
-- ==============================================================================
...
BEGIN
    -- 1. Create or ensure Auth Users exist in Supabase auth.users
    ...
    -- 3. Default Enterprise Core Tenant
    INSERT INTO tenants (
    ...
    VALUES
    (base_core_id, prj_modernize_id, tenant_core_id, 'Executive Baseline v1.0 (Q4 Approved)', 'Approved by the Technical Steering Committee prior to infrastructure sprint kickoff.', super_admin_id, '2026-09-25T00:00:00Z')
    ON CONFLICT (id) DO NOTHING;
    ...
    (base_core_id, t2_id, '2026-10-06', '2026-10-12', 5, 40),
